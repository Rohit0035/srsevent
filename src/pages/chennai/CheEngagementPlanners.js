...
const eventServices = [
  {
    title: "Engagement Party Planning in Hyderabad",
  ...
  },
  {
    ...
    desc: "End-to-end engagement services including wardrobe styling, guest hospitality, and complete event coordination in Hyderabad.",
    img: Gal3,
...
const CheEngagementPlanners = () => {
  return (
    <>
      <Helmet>
        <title>Engagement Planners in Hyderabad | Proposal & Event Experts - SRS Weddings</title>
        <meta
          name="description"
          content="SRS Weddings are expert engagement planners in Hyderabad. We organize creative proposals, luxury engagement parties, wardrobe styling, guest hospitality, and personalized engagement packages."
        />
        <meta
          name="keywords"
            ...
            <div className='col-12 col-md-12 col-lg-5 mb-2 text-center' id="enquirynow">
              <div className='bg-pink py-4 rounded-5'>
                <ScrollAnimation animateIn='fadeInRight'>
                  <h2 className='text-white fs-4'>Book Your Engagement Planner in Hyderabad!</h2>
...
export default CheEngagementPlanners;
